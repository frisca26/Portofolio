...
export const DATA = {
  ...
  summary:
    "Digital Strategist & Content Creator dengan pengalaman dalam mengembangkan konsep, strategi konten, dan visual untuk membangun digital presence yang konsisten. Terbiasa mengelola proses kreatif dari ide, produksi, hingga publikasi.",
  ...
  contact: {
    email: "friscaworkspace@gmail.com",
    tel: "0881-0238-27191",
    social: {
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/friscabalqistyadharma",
        icon: Icons.linkedin,
        navbar: true,
      },
      Instagram: {
  ...
  work: [
    ...
    {
      company: "Yayasan Mutiara Titipan Illahi",
      href: "#",
      badges: [],
      location: "Bandung, Jawa Barat",
      ...
      description:
        "Merumuskan strategi dan memproduksi aset konten kreatif untuk program donasi digital yang berhasil meningkatkan metrik engagement dan reach organik. Melakukan redesign website dan company profile untuk meningkatkan trust rate donatur.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Mendampingi ekstrakurikuler Green School Team, merencanakan program kerja kebersihan dan lingkungan hidup terstruktur, serta membangun kolaborasi antar-siswa untuk pencapaian standar Sekolah Adiwiyata.",
    },
  ],
  education: [
    {
      school: "Universitas Nurtanio Bandung",
      href: "#",
